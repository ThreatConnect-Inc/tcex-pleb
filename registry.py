...
if TYPE_CHECKING:
    from ..app.app import App  # type: ignore # pylint: disable=import-error
    ...
    from ..exit.exit import Exit  # type: ignore # pylint: disable=import-error
    from ..input.input import Input  # type: ignore # pylint: disable=import-error
    from ..requests_session.requests_session import (  # type: ignore # pylint: disable=import-error
        RequestsSession,
    )
    from ..requests_session.tc_session import (  # type: ignore # pylint: disable=import-error
        TcSession,
    )
